...
const experiences = [
  ...
  },
  {
    ...
    desc: "Foundational years at Walmart Brazil, BuscaPé (anti-fraud), PRNewswire, FCamara, MPS. Systems handling millions of transactions. SQL performance optimization, unit testing, CI. Started managing teams with Scrum. Built discipline in performance engineering, scalability, and clean code.",
    tags: ["ASP.NET / C#", "SQL Server", "jQuery", "Scrum"],
  },
];
